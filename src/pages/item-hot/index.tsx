...
const ItemHot = () => {
    ...
    // Declarations State
    const [itemHots, setItemHot] = useState<[]>([]);
     ...
     * Fetch items hot
     */
    const handleFetchItemHot = async () => {
        // Prepare params
        const params = {
            ...queryParams
        } as any;
        params.is_top_hot = true;
    ...
    return (
        <div className='css-promotion-wrapper'>
            <Head>
                <title>Sản phẩm hot | Cocolux.com</title>
                <meta property='og:url' content='https://Cocolux.com' data-rh='true'></meta>
                <meta property='og:title' content='Sản phẩm hot | Cocolux.com' />
            ...
            <div className='css-promotion-wrapper--header'>
                <div className='promotion-nav'>
                    <Link href='/item-hot'>
                        <a className='nav-item active'>SẢN PHẨM HOT</a>
                    </Link>
                </div>
            </div>
            <div className='section bg-white py-5'>
                <div className='row no-margin'>
                    ...
                    {!itemHots.length && <NotFound content={'Không có sản phẩm hot'} />}
                </div>
